    ...
    return (
        <div className="relative min-h-screen overflow-y-auto overflow-x-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('https://images.unsplash.com/photo-1506703719100-f0b3c5c4e5c4?q=80&w=2070')",
                    backgroundAttachment: isMobile ? "scroll" : "fixed"
                }}
            />

            {/* Темный фиолетовый градиент поверх */}
            ...
            <div className="relative z-10 pb-20">
                ...
                <div className="min-h-[80vh] flex items-center justify-center px-4 pt-10">
                    <div className="text-center">
                        <h1 className="text-4xl md:text-7xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-purple-400 via-fuchsia-500 to-purple-500 bg-clip-text text-transparent">
                            🦊 LisaDesign
                        </h1>
                        <p className="text-sm md:text-lg text-purple-200 mb-6 md:mb-12">
                            Современный дизайн • Анимации • Адаптив
                        </p>
                        <button className="group relative px-6 md:px-8 py-2 md:py-4 bg-purple-800 hover:bg-purple-700 rounded-full overflow-hidden transition-all duration-300 hover:scale-105 shadow-lg shadow-purple-600/30">
                            <span className="relative z-10 text-white font-semibold text-sm md:text-base">
                                Наши работы
                            </span>
                            <div className="absolute inset-0 bg-gradient-to-r from-purple-700 to-fuchsia-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                        </button>
                    </div>
                </div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                            {[
                                ...
                                <div
                                    key={idx}
                                    className="group bg-purple-950/40 backdrop-blur-md rounded-2xl p-6 border border-purple-500/20 hover:border-fuchsia-500/50 transition-all duration-300 hover:scale-105 text-center"
                                >
                ...
                <div className="container mx-auto px-4 py-10 md:py-16">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
                        {[
                            ...
                            <div
                                key={idx}
                                className="group bg-purple-950/40 backdrop-blur-md rounded-2xl p-4 md:p-6 border border-purple-500/20 hover:border-fuchsia-500/50 transition-all duration-300 hover:scale-105"
                            >
                                ...
                                <p className="text-purple-200/70 text-sm md:text-base mb-3 md:mb-4">{card.desc}</p>
                ...
                {/* Контакты */}
                <div className="container mx-auto px-4 py-10 md:py-16">
                    <div className="max-w-2xl mx-auto bg-purple-950/40 backdrop-blur-md rounded-2xl p-6 md:p-8 border border-purple-500/20 text-center">
                        <h2 className="text-3xl md:text-4xl font-bold text-purple-100 mb-6">
                            Контакты
                        </h2>
                        <div className="space-y-4">
                            <p className="text-purple-200/80 text-lg break-all">
                            ...
                            <div className="flex justify-center gap-4 pt-4">
                                <a href="https://t.me/+79668043676" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-purple-800/50 hover:bg-purple-700 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110">
                                    <svg className="w-6 h-6 text-purple-200" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.6-1.38-.97-2.23-1.56-.99-.68-.35-1.06.22-1.67.15-.15 2.71-2.48 2.76-2.69.01-.03.01-.14-.07-.19-.08-.06-.2-.04-.28-.02-.11.02-1.85 1.18-5.23 3.47-.5.34-.94.51-1.34.5-.44-.01-1.28-.25-1.91-.45-.77-.25-1.38-.38-1.33-.81.03-.23.34-.46.95-.7 3.73-1.62 6.22-2.69 7.47-3.21 3.56-1.49 4.3-1.75 4.78-1.76.11 0 .35.03.51.2.13.15.17.35.18.45.01.04-.01.16-.03.25z"/></svg>
                                </a>
                                <a href="https://t.me/+79668043676" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-purple-800/50 hover:bg-purple-700 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110">
                                    <span className="text-purple-200 font-bold text-sm">MAX</span>
                                </a>
                            </div>
                        </div>
                    </div>
